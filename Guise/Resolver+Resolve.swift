...
public extension Resolver {
  ...
  func resolve<Type, Arg1, Arg2, Arg3>(type: Type.Type = Type.self, scope: Scope = .default, arg1: Arg1, arg2: Arg2, arg3: Arg3) -> Type? {
    resolve(type: type, scope: scope, arg: (arg1, arg2, arg3))
  }
}
