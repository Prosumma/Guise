...
class LazyResolverTests: XCTestCase {
  ...
  func test_sync0() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 0)
  ...
  func test_sync1() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 1, args: 0)
  ...
  func test_sync2() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 2, args: 0, 1)
  ...
  func test_sync3() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 3, args: 0, 1, 2)
  ...
  func test_sync4() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 4, args: 0, 1, 2, 3)
  ...
  func test_sync5() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 5, args: 0, 1, 2, 3, 4)
  ...
  func test_sync6() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 6, args: 0, 1, 2, 3, 4, 5)
  ...
  func test_sync7() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 7, args: 0, 1, 2, 3, 4, 5, 6)
  ...
  func test_sync8() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 8, args: 0, 1, 2, 3, 4, 5, 6, 7)
  ...
  func test_sync9() throws {
    ...
    // When
    let ints: [Int] = try lr.resolve(name: 9, args: 0, 1, 2, 3, 4, 5, 6, 7, 8)
  ...
  func test_resolve_sync_weak() throws {
    ...
    // Then
    do {
      _ = try lr.resolve(name: "s", args: 7)
  ...
  func test_async0() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 0)
  ...
  func test_async1() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 1, args: 0)
  ...
  func test_async2() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 2, args: 0, 1)
  ...
  func test_async3() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 3, args: 0, 1, 2)
  ...
  func test_async4() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 4, args: 0, 1, 2, 3)
  ...
  func test_async5() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 5, args: 0, 1, 2, 3, 4)
  ...
  func test_async6() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 6, args: 0, 1, 2, 3, 4, 5)
  ...
  func test_async7() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 7, args: 0, 1, 2, 3, 4, 5, 6)
  ...
  func test_async8() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 8, args: 0, 1, 2, 3, 4, 5, 6, 7)
  ...
  func test_async9() async throws {
    ...
    // When
    let ints: [Int] = try await lr.resolve(name: 9, args: 0, 1, 2, 3, 4, 5, 6, 7, 8)
  ...
  func test_resolve_async_weak() async throws {
    ...
    // Then
    do {
      _ = try await lr.resolve(name: "s", args: 7)
      XCTFail("Expected resolution to fail.")
    } catch let error as ResolutionError {
      let key = Key(Service.self, tags: "s", args: Int.self)
      guard
