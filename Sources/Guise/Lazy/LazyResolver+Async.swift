...
public extension LazyResolver {
  ...
  func resolve<A1, A2>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2))
  }
  ...
  func resolve<A1, A2, A3>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3))
  }
  ...
  func resolve<A1, A2, A3, A4>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3, arg4))
  }
  ...
  func resolve<A1, A2, A3, A4, A5>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3, arg4, arg5))
  }
  ...
  func resolve<A1, A2, A3, A4, A5, A6>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3, arg4, arg5, arg6))
  }
  ...
  func resolve<A1, A2, A3, A4, A5, A6, A7>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3, arg4, arg5, arg6, arg7))
  }
  ...
  func resolve<A1, A2, A3, A4, A5, A6, A7, A8>(
    ...
    try await resolve(name: Set(name), args: (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8))
  }
