...
public extension Resolver {
    ...
    default:
      ...
      do {
        ...
        case let type as ResolutionAdapter.Type:
          return try type.resolve(tags: tags, args: arg1, with: self) as! T
        default:
          throw error
        }
      }
  ...
  func resolve<T, each A>(
    ...
    try resolve(type, tags: Set(tags), args: (repeat each args))
  }
  ...
  func resolve<T, A>(
    ...
    try resolve(type, tags: Set(tags), args: arg1)
  }
